---
id: "PF-PLAYBOOK-CONTREPOINT-ACT1-v1"
title: "Pathfinder Playbook — Contrepoint (Acte I — Les Coutures du Monde)"
category: "playbook"
status: "active"
last_updated: "2026-03-22"
---

# One‑Page Start — Contrepoint / Acte I — Les Coutures du Monde
- **Pitch :** ⚑
- **Cadre/Tonalité :** Politique tendu, enquête, thriller médiéval‑fantastique.
- **Arcs :**
  - ARC‑01 — Les Coutures du Monde (Acte I)
- **Hooks PJ (3) :** ⚑ / ⚑ / ⚑
- **Beats (macro 5) :** Ouverture • Incident • Pression • Fracture • Arbitrage
- **Ressources :** [[SPINE_Contrepoint_ActeI_v4.0]] [[INDEX_GLOBAL]] [[LORE_*]] [[PNJ_*]] [[LIEU_*]]

---
# Scènes (extraites du SPINE)
